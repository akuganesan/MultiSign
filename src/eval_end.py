...
from runner_end import basic_test, endToEnd_test
...
if __name__ == "__main__":
    ...
    """LOAD THE DATASET"""
    test_dataset = SIGNUMDataset(dataset_root, use_pose=True, subsample=subsample,\
                                  testing=True, use_image=True, normalize_poses=True, speaker_id=speaker_id)
    ...
    decoder = torch.load(model_file, map_location=device)
    print("LOADING: {} from training epoch unknown ;(".format(model_file))
#     decoder.load_state_dict(checkpoint["model_state_dict"])
    ...
    if end_to_end:
        ...
        print("Loss on Testing Dataset after Epoch unknown of Training = {}".format(test_loss))
